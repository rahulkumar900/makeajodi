...
export default function Privacy() {
  return (
    <Container className="max-w-7xl mx-auto prose md:prose-md text-white">
      <h1 className="text-white">Privacy Policy</h1>
      <p>
        {" "}
        MakeAJodi has made makeajodi.com website. This page is used to inform
        ...
        MakeAJodi unless otherwise defined in this Privacy Policy.
      </p>
      <h2 className="text-white">Information Collection and Use</h2>
      <p>
        For a better experience, while using our Service, we may require you to
        provide us with certain personally identifiable information, including
        but not limited to Phone number, . The information that we request will
        be retained by us and used as described in this privacy policy. The app
