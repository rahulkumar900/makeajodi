...
export default function home() {
  return (
    <div className=" snap-mandatory snap-y">
      ...
      <Container className=" bg-[url('')]  bg-no-repeat bg-cover  story  text-white 
       relative ">
        <div className="absolute inset-0 w-full h-full  bg-gradient-to-r from-red-500 to-orange-500 opacity-90 -z-10   "></div>
        <div className=" mx-auto  max-w-7xl px-2 md:px-8  py-16 text-center space-y-10 ">
          <h4 className=" z-10 text-3xl relative text-white md:text-5xl font-serif font-bold">
