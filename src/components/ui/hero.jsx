...
export default function Hero() {
  return (
    <Container className="relative flex px-0  w-full h-screen bg-gradient-to-r from-red-500 to-orange-500 ">
      <section className="px-2 md:px-8 py-8 max-w-7xl flex-shrink-0 flex-1  mx-auto flex justify-between items-center   ">
        <div className="hidden md:block h-full  w-1/2 flex-1"></div>
